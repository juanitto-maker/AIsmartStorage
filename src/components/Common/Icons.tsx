...
export const MusicIcon: Component<IconProps> = (props) => (
  <svg
    width={props.size || 20}
    height={props.size || 20}
    viewBox="0 0 24 24"
...
export const MessageCircleIcon: Component<IconProps> = (props) => (
  <svg
    width={props.size || 20}
    height={props.size || 20}
    viewBox="0 0 24 24"
...
export const HardDriveIcon: Component<IconProps> = (props) => (
  <svg
    width={props.size || 20}
    height={props.size || 20}
    viewBox="0 0 24 24"
...
export function getFileTypeIcon(fileType: string): Component<IconProps> {
  switch (fileType) {
    case 'image':
      return ImageIcon;
    case 'video':
